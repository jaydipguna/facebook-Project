...
import { IFriendState, IUser } from "../../types/types";
...
const friendRequestSlice = createSlice({
  ...
  reducers: {
    ...
    setUsers(
      ...
      console.log("action in setUsers", action.payload);
    ...
    setFriendError(state, action: PayloadAction<string>) {
